...
func (c *serviceClient) CreateStripeCheckout(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*StripeUrlResponse, error) {
	out := new(StripeUrlResponse)
	err := c.cc.Invoke(ctx, "/proto.Service/CreateStripeCheckout", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceClient) CreateStripePortal(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*StripeUrlResponse, error) {
	out := new(StripeUrlResponse)
	err := c.cc.Invoke(ctx, "/proto.Service/CreateStripePortal", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedServiceServer) CreateStripeCheckout(context.Context, *Empty) (*StripeUrlResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateStripeCheckout not implemented")
}
func (UnimplementedServiceServer) CreateStripePortal(context.Context, *Empty) (*StripeUrlResponse, error) {
...
func _Service_CreateStripeCheckout_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ServiceServer).CreateStripeCheckout(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.Service/CreateStripeCheckout",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServiceServer).CreateStripeCheckout(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}

func _Service_CreateStripePortal_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ServiceServer).CreateStripePortal(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.Service/CreateStripePortal",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServiceServer).CreateStripePortal(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Service_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Service_CreateStripeCheckout_Handler,
		},
		{
			MethodName: "CreateStripePortal",
			Handler:    _Service_CreateStripePortal_Handler,
		},
		{
