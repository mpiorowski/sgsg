...
We are also adding **SCALABILITY** to the mix with the usage of [Fly.io](https://fly.io/) and [Turso](https://turso.tech/). Checkout the my [article](https://dev.to/mpiorowski/breaking-the-myth-scalable-multi-region-low-latency-app-exists-and-will-not-cost-you-a-kidney-537a) to know more.
